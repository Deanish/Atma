                    ...
                    <div class="zerogrid">
                        <div class="wrapper">
                            <article class="col-1-3">
                                ...
                                <div class="wrapper indent-bot2">
									<div class="extra-wrap">
                                        <h4 class="p1"><a href="msg.php">Messages from dignities</a></h4>
                                    </div>
                                </div>
								</div>
                            </article>
                            <article class="col-2-3">
								<div class="wrap-col">
                            	<div>
                                	<h3>Messages from dignities about padyaatra</h3>
                                </div>
                                <div class="wrapper indent-bot">
                                	<article class="col-1-2">
										<div class="wrap-col">
										<h4 class="p1"><a href="abv.php">Sri. Atal Bihari Vajpayee</a><br /><span style="font-size:10px">Former Prime Minister of India</span></h4>
										<h4 class="p1"><a href="mms.php">Dr. Manmohan Singh</a><br /><span style="font-size:10px">Prime Minister of India</span></h4>
										<h4 class="p1"><a href="lka.php">L.K Advani</a><br /><span style="font-size:10px">Leader of opposition</span></h4>
										<h4 class="p1"><a href="tnc.php">T.N Chaturvedi</a><br /><span style="font-size:10px">Retired IAS officer</span></h4>
										</div>
                                    </article>
									<article class="col-1-2">
										<div class="wrap-col">
