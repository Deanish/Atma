                        ...
                        <div class="wrapper">
                            <article class="col-1-3">
                                ...
                                <div class="wrapper indent-bot2">
                                    <div class="extra-wrap">
										<h4 class="p1"><a href="atma.php">Atma Darshana Yoga</a></h4>
                                        <h4 class="p1">Yoga Therapy</h4>
										<h4 class="p1">Yoga Counselling</h4>
										<h4 class="p1">Ayurveda</h4>
										<h4 class="p1">Astrology</h4>
										<h4 class="p1">Acupressure</h4>
										<h4 class="p1">Muscular Problems</h4>
										<h4 class="p1">Energy Healing</h4>
										<h4 class="p1">Naturopathy</h4>
										<h4 class="p1">Homeopathy</h4>
										<h4 class="p1">Reiki</h4>
										<h4 class="p1">Pranic HEaling</h4>
                                    </div>
                                </div>
								</div>
                            </article>
                            <article class="col-2-3">
                                ...
                                <div class="wrapper indent-bot">
									...
									<article class="col-1-2">
										<div class="wrap-col">
											<h3>We also provide services on</h3>
											<h4 class="p1">Body Massage</h4>
											<h4 class="p1">Steam Bath</h4>
											<h4 class="p1">Neti, Vamana Dhouthi</h4>
											<h4 class="p1">Head & Foot Massage</h4>
											<h4 class="p1">Enema</h4>
											<h4 class="p1">Trataka</h4>
										</div>
										</div>
                                    </article>
                                </div>
